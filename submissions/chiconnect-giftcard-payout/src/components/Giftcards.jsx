    ...
    return (
        <div className='flex flex-col'>
            <input placeholder='Filter gift cards' onChange={handleChange}
                value={searchTerm}
                className='ml-auto mt-3 px-3 py-2 mr-3 max-w-xs bg-white border shadow-sm 
            ...
            <div className='flex flex-row mt-6 justify-between items-start'>
                ...
                <div className='grid grid-cols-3 p-3 gap-6 min-h-[150px] max-h-[450px] overflow-y-scroll justify-evenly items-center'>
                    {
                        giftcards.map((item) =>
                            <Giftcard
                                key={item.productId}
