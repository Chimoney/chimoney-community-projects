...
const Giftcards = ({ handleCardClick }) => {
    ...
    return (
        <div className='flex flex-col'>
            <div className='flex flex-row justify-end mt-3 space-x-6'>
                ...
                <input placeholder='Search gift cards' onChange={handleSearchChange}
                    value={searchTerm}
                    className='px-3 py-2 mr-3 max-w-xs bg-white border shadow-sm border-slate-300 
            ...
            <div className='flex flex-row mt-6 justify-between items-start'>
                ...
                {
                    loading &&
                    <div className='flex flex-col ml-72 justify-around items-center'>
                ...
                <div className='grid grid-cols-3 p-3 gap-6 min-h-[150px] max-h-[450px] overflow-y-scroll justify-center items-center'>
                    {
